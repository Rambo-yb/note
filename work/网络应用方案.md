...
| V1.1.3 | 1.新增bdc分划信息的获取/设置/上报                                                                                                                                                   | 2025.09.16 | V1.0.5<br>DOT弹弓瞄                             |
| V1.1.4 | 1.新增根据文件名获取设备端文件接口<br>2.根据获取分划样式资源流程，修改分划样式能力                                                                                                                          | 2025.09.24 |                                              |
| V1.1.5 | 1.移除画面冻结控制请求<br>2.添加获取/设置图像状态接口<br>3.语言类型，增加芬兰，丹麦                                                                                                                      | 2025.10.17 |                                              |
...
2.修改ip
设备和PC不在统一网段，通过组播进行跨网段IP修改，字符串拼接"modify cdjp device addr:<old_addr>_<new_addr>_<new_mask>_<new_gateway>"
request boby: "modify cdjp device addr:192.168.100.223_192.168.110.223_255.255.255.0_192.168.110.1"

response boby:
{
	"old_addr":"192.168.100.223",
    ...
    "data":{
        "support_function":{
            ...
            "camera_ir_function":[{    // 红外机芯功能
                ...
                "image_state_function": {
	                "freeze_video_support":0 // 画面冻结状态
                }
            }],
            ...
            "display_screen_function":{    // 显示屏功能
                "display_info_function":{
                    ...
                    "picture_in_picture_zoom_support":{ // 画中画变倍
	                    "support_state":0, "min":1, "max":8,
						"sequence_type":0, // 数列类型，【0：等差】【1：等比】
						"common_value":0.1 // 公差/公比值
                    },
...
9.图像状态
"camera_ir.image_state":[{
	"freeze_video":0
}]
freeze_video:画面冻结状态，【true/false】
```
##### 3.可见光摄像头配置
```json
1.图像信息
...
"display_screen.display_info":{
    "picture_in_picture":0,
    "picture_in_picture_zoom":0,
    "electronic_compass":0,
    "language":0
}
picture_in_picture:画中画，【0：关闭】【1：左上】【2：中上】【3：右上】
picture_in_picture_zoom:画中画变倍
electronic_compass:电子罗盘，【true/false】
language:语言，【0：中】【1：英】【2：俄】【3：西班牙】【4：德】【5：法】【6：葡萄牙】【7：繁中】【8：挪威】【9：瑞典】【10：芬兰】【11：丹麦】
